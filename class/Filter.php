...
class Filter extends Qwik {
    ...
    const VALID_QWIK = array('accept', 'account', 'activate', 'available', 'cancel', 'deactivate', 'decline', 'delete', 'friend', 'feedback', 'keen', 'login', 'logout', 'msg', 'recover', 'region', 'register', 'translate', 'upload');
