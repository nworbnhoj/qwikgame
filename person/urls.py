...
from person.views import AccountView, BlockView, NotifyEmailView, PrivateView, PublicView, PWAView, SocialView, UpgradeView
...
urlpatterns = [
    ...
    path("social_add/", SocialView.as_view(), name='social_add'),
