...
from player.views import AcceptView, BidView, FeedView, FilterView, FriendAddView, FriendsView, FriendView, InvitationView, KeenView, RivalView, BidView, FiltersView
